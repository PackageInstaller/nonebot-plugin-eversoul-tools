...
es_bind = on_command("es绑定", aliases={"es绑定账号", "es账号绑定"}, priority=5, block=True)
es_unbind = on_command("es解绑", aliases={"es解绑账号", "es账号解绑"}, priority=5, block=True)
...
from .es_string_utils import (
    ...
    format_character_story, get_cash_pack, get_string_item, 
    ...
    get_character_keyword_source, get_character_arbeit, get_character_soullink, get_character_story,
